(function() {
	...
	app.config(function($stateProvider, $urlRouterProvider, $controllerProvider){
		...
		$stateProvider
			...
			.state('questions',{
	        url:'/questions',
	        templateUrl: viewsPrefix + 'questions.html',
	        controller:'QuestionListController'
	    }).state('viewQuestion',{
	       url:'/questions/:id/view',
	       templateUrl: viewsPrefix + 'question-view.html',
	       controller:'QuestionViewController'
	    }).state('newQuestion',{
	        url:'/questions/new',
	        templateUrl: viewsPrefix + 'question-add.html',
	        controller:'QuestionCreateController'
	    }).state('editQuestion',{
	        url:'/questions/:id/edit',
	        templateUrl: viewsPrefix + 'question-edit.html',
